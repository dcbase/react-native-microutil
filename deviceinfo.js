 ...
 */
import { Platform, NativeModules, Dimensions, Linking } from 'react-native';
...
export default {
  ...
  getDeviceInfo: function() {
    let deviceInfoStr=`${RNDeviceInfo.appName},${RNDeviceInfo.uniqueId},${RNDeviceInfo.instanceId},${RNDeviceInfo.serialNumber},${RNDeviceInfo.getIpAddress()},${RNDeviceInfo.getCameraPresence()},${RNDeviceInfo.getMacAddress()},${RNDeviceInfo.deviceId},${RNDeviceInfo.systemManufacturer},${RNDeviceInfo.brand},${RNDeviceInfo.systemName},${RNDeviceInfo.systemVersion},${RNDeviceInfo.buildId},${RNDeviceInfo.apiLevel},${RNDeviceInfo.bundleId},${RNDeviceInfo.buildNumber},${RNDeviceInfo.appVersion},${RNDeviceInfo.appVersion}.${RNDeviceInfo.buildNumber},${RNDeviceInfo.deviceName},${RNDeviceInfo.userAgent},${RNDeviceInfo.deviceLocale},${RNDeviceInfo.preferredLocales},${RNDeviceInfo.deviceCountry},${RNDeviceInfo.timezone},${RNDeviceInfo.fontScale},${RNDeviceInfo.isEmulator},${RNDeviceInfo.isTablet},${RNDeviceInfo.is24Hour},${RNDeviceInfo.isPinOrFingerprintSet},${RNDeviceInfo.firstInstallTime},${RNDeviceInfo.installReferrer},${RNDeviceInfo.lastUpdateTime},${RNDeviceInfo.phoneNumber},${RNDeviceInfo.carrier},${RNDeviceInfo.deviceType},${RNDeviceInfo.supportedABIs},${RNDeviceInfo.deviceType},${RNDeviceInfo.isAutoTimeZone()},${RNDeviceInfo.getBatteryLevel()},${RNDeviceInfo.getSystemAvailableFeatures()}`;
